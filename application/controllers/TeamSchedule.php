...
/**
 * Description of TeamSchedule
 *
 * @author Angel Bunny Empeynado
 */
class TeamSchedule extends MY_Controller {
    ...
    public function index() {
        if ($this->has_logging_in()) {
            $data["page_title"] = "Team Work Schedule";
            $data['page'] = 'pages/menu/team_work_schedule/team_work_schedule';
            $data["css"] = array
                (
            ...
            $data["js"] = array
                ...
                'assets/myjs/team_work_schedule/team_work_schedule.js',
            );
