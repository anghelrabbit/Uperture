                    ...
                    <div class="pad">
                        <div class="nav-tabs-custom " id="table_tabs">
                            <ul class="nav nav-tabs ">
                                ...
                                <li class="active" >
                                    <a href="#today_payments" data-toggle="tab"  onclick="tabCategory(0)">Payments Today&nbsp;&nbsp;</a>
                                </li>
                                <li class="" >
                                    <a href="#done_payments" data-toggle="tab"  onclick="tabCategory(0)">Done  Payments&nbsp;&nbsp;</a>
                                </li>


                            </ul>   
                            <div class="tab-content">
                                <div class="active tab-pane" id="today_payments" >
                                    <?php $this->load->view('pages/menu/payroll/tabs/payments_today'); ?>
                                </div>
                                <div class="tab-pane" id="done_payments" >
                                    <?php $this->load->view('pages/menu/payroll/tabs/done_payments'); ?>
                                </div>
