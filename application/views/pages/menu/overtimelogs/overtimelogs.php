                    ...
                    <div class="pad">
                        <div class="nav-tabs-custom " id="table_tabs">
                            <ul class="nav nav-tabs ">
                                ...
                                <li class="active" >
                                    <a href="#members_overtime_logs" data-toggle="tab"  onclick="tabCategory(0)">Pending Overtime Logs&nbsp;&nbsp;</a>
                                </li>
                                <li class="" >
                                    <a href="#approved_overtime_logs" data-toggle="tab"  onclick="tabCategory(0)">Approved Overtime Logs&nbsp;&nbsp;</a>
                                </li>
                                <li class="" >
                                    <a href="#denied_overtime_logs" data-toggle="tab"  onclick="tabCategory(0)">Denied Overtime Logs&nbsp;&nbsp;</a>
                                </li>


                            </ul>   
                            <div class="tab-content">
                                <div class="active tab-pane" id="members_overtime_logs" >
                                    <?php $this->load->view('pages/menu/overtimelogs/tabs/members_overtime_logs'); ?>
                                </div>
                                <div class="tab-pane" id="approved_overtime_logs" >
                                     <?php $this->load->view('pages/menu/overtimelogs/tabs/approved_overtime_logs'); ?>
                                </div>
                                <div class="tab-pane" id="denied_overtime_logs" >
                                     <?php $this->load->view('pages/menu/overtimelogs/tabs/denied_overtime_logs'); ?>
                                </div>
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#overtimelogs_menu').addClass('active');
