    ...
    <table id="schedule_table" class="table table-striped table-bordered" style="width:100%;">
        <thead style="background-color:#2692D0;color:white;">
            <tr>
                ...
                <th style="white-space:nowrap;padding-right: 70px"  rowspan="2">Date Coverage</th>
                <th style="white-space:nowrap;padding-right: 70px"  rowspan="2">Member</th>
                <th style="white-space:nowrap;padding-right: 70px"  rowspan="2">Total Overtime Hours</th>
                <th style="white-space:nowrap;padding-right: 70px"  rowspan="2">Total</th>
                <th style="white-space:nowrap;padding-right: 70px"  rowspan="2">Approved By</th>
