                    ...
                    <div class="pad">
                        <div class="nav-tabs-custom " id="table_tabs">
                            <ul class="nav nav-tabs ">
                                ...
                                <li class="active" >
                                    <a href="#members_last_payments" data-toggle="tab"  onclick="tabCategory(0)">Last Payments&nbsp;&nbsp;</a>
                                </li>
                            ...
                            <div class="tab-content">
                                <div class="active tab-pane" id="members_last_payments" >
                                    <?php $this->load->view('pages/menu/last_payments/tabs/members_last_payments'); ?>
                                </div>
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#last_payments_menu').addClass('active');
