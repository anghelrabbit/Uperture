                    ...
                    <div class="pad">
                        <div class="nav-tabs-custom " id="table_tabs">
                            <ul class="nav nav-tabs ">
                                ...
                                <li class="active" >
                                    <a href="#pending_reimbursement_request" data-toggle="tab"  onclick="tabCategory(0)">Pending Reimbursement Requests&nbsp;&nbsp;</a>
                                </li>
                                <li class="" >
                                    <a href="#ongoing_reimbursements" data-toggle="tab"  onclick="tabCategory(0)">Ongoing Reimbursements&nbsp;&nbsp;</a>
                                </li>
                                <li class="" >
                                    <a href="#denied_reimbursement_requests" data-toggle="tab"  onclick="tabCategory(0)">Denied Reimbursement Requests&nbsp;&nbsp;</a>
                                </li>
                                <li class="" >
                                    <a href="#approved_reimbursement_requests" data-toggle="tab"  onclick="tabCategory(0)">Approved Reimbursement Requests&nbsp;&nbsp;</a>
                                </li>


                            </ul>   
                            <div class="tab-content">
                                <div class="active tab-pane" id="pending_reimbursement_request" >
                                    <?php $this->load->view('pages/menu/reimbursements/tabs/pending_reimbursement_request'); ?>
                                </div>
                                <div class="tab-pane" id="ongoing_reimbursements" >
                                    <?php $this->load->view('pages/menu/reimbursements/tabs/ongoing_reimbursements'); ?>
                                </div>
                                 <div class="tab-pane" id="denied_reimbursement_requests" >
                                    <?php $this->load->view('pages/menu/reimbursements/tabs/denied_reimbursement_requests'); ?>
                                </div>
                                 <div class="tab-pane" id="approved_reimbursement_requests" >
                                    <?php $this->load->view('pages/menu/reimbursements/tabs/approved_reimbursement_requests'); ?>
                                </div>
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#reimbursement_menu').addClass('active');
