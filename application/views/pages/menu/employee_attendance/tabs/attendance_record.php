    ...
    <table id="schedule_table" class="table table-striped table-bordered" style="width:100%;">
        <thead style="background-color:#2692D0;color:white;">
            <tr>
                ...
                <th style="white-space:nowrap;padding-right: 70px"  rowspan="2">Total Absences</th>
                <th style="white-space:nowrap;padding-right: 70px"  rowspan="2">Total Under times</th>
