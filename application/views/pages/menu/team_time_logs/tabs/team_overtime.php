    ...
    <table id="my_leave_table" class="table table-striped table-bordered" style="width:100%;">
        <thead style="background-color:#2692D0;color:white;">
            <tr>
                ...
                <th style="white-space:nowrap;padding-right: 70px">Member</th>
                <th style="white-space:nowrap;padding-right: 70px">Date of Overtime</th>
                <th style="white-space:nowrap;padding-right: 70px">Total Time</th>
