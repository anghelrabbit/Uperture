        ...
        <div class="box-body">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs " name="request_forms_tabs" > 
                    ...
                    <li class="active" name="leave_li" ><a  href="#my_leave" data-toggle="tab">Pending Reimbursement<i  class=""></i></a></li>
                    <li class=""  name="cs_li"><a  href="#my_changesched" data-toggle="tab">Ongoing Reimbursement</i></a></li>
                    <li class=" " name="undertime_li" ><a  href="#my_undertime" data-toggle="tab">Approved Reimbursements</a></li>
                ...
                <div class="tab-content" style="color:black">
                    <div class="active tab-pane" id="my_leave">
                        <?php $this->load->view('pages/menu/my_account/request_forms/tabs/pending_reimbursement') ?>
                    </div>
                    <div class="tab-pane" id="my_undertime">
                        <?php $this->load->view('pages/menu/my_account/request_forms/tabs/ongoing_reimbursements') ?>
                    </div>
                    <div class="tab-pane" id="my_changesched">
                        <?php $this->load->view('pages/menu/my_account/request_forms/tabs/approved_reimbursements') ?>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#RequestReimbursementHolder').addClass('active');
        $('#requestreimbursementcircle').addClass('text-aqua');
