...
<div class="box-body" style="max-width: 100%;  overflow: auto;"> 
    ...
    <br> 
    <table id="ongoing_reimbursement_table" class="table table-striped table-bordered" style="width:100%;">
        <thead style="background-color:#2692D0;color:white;">
            <tr>
                ...
                <th style="white-space:nowrap;padding-right: 70px">Remaining Payment</th>
