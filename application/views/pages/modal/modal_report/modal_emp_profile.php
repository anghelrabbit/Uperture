<div class="modal modal-primary fade" name="modal_emp_profile">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" style="color:black;font-weight: bold">X</span></button>
                <h4 class="modal-title" name="cs_title">Employee Profile</h4>
            </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="box box-primary">
                                                <div class="box-body box-profile">
                                                    <img src="data:image;base64,<?php echo $this->session->userdata('profilepic'); ?>" class="profile-user-img img-responsive img-circle" alt="User profile picture">
